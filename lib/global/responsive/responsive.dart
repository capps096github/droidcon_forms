...
class DroidconResponsive {
// context
  final BuildContext context;

  DroidconResponsive({required this.context});
  ...
  bool get isMobileScreen =>
      DroidconResponsive.isMobile(context) ||
      DroidconResponsive.isMediumMobile(context) ||
      DroidconResponsive.isSmallMobile(context);

  /// getter for isTablet or isMediumTablet or isLargeTablet
  bool get isTabletScreen =>
      DroidconResponsive.isTablet(context) ||
      DroidconResponsive.isMediumTablet(context) ||
      DroidconResponsive.isLargeTablet(context);

  /// getter for isDesktop
  bool get isDesktopScreen => DroidconResponsive.isDesktop(context);
}
